 ...
 */
class DefaultMessagingFactory extends pip_services4_components_node_1.Factory {
    /**
...
DefaultMessagingFactory.MemoryQueueDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "message-queue", "memory", "*", "1.0");
DefaultMessagingFactory.MemoryQueueFactoryDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "queue-factory", "memory", "*", "1.0");
