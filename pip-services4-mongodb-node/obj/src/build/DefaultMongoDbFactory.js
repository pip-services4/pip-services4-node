 ...
 */
class DefaultMongoDbFactory extends pip_services4_components_node_1.Factory {
    /**
...
DefaultMongoDbFactory.MongoDbConnectionDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "connection", "mongodb", "*", "1.0");
