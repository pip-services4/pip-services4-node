...
class DummyService {
    ...
    getPageByFilter(context, filter, paging) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            paging = paging != null ? paging : new pip_services4_data_node_2.PagingParams();
            ...
            return new pip_services4_data_node_3.DataPage(result);
        });
    }
    ...
    create(context, entity) {
        return __awaiter(this, void 0, void 0, function* () {
            if (entity.id == null) {
                entity.id = pip_services4_data_node_4.IdGenerator.nextLong();
