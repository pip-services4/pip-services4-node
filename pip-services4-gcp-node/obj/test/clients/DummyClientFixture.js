...
class DummyClientFixture {
    ...
    startCloudControllerLocally() {
        return __awaiter(this, void 0, void 0, function* () {
            let ff = (0, child_process_1.exec)(`npx functions-framework --target=${this.functionName} --signature-type=http --port=${this.port} --source=test/controllers`);
    ...
    testCrudOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Get all dummies
            const dummyDataPage = yield this._client.getDummies(null, new pip_services4_data_node_1.FilterParams(), new pip_services4_data_node_2.PagingParams(0, 5, false));
