...
suite('Descriptor', ()=> {
    ...
    test('Equals', () => {
		let descriptor1 = Descriptor.fromString("pip-dummies:controller:default:default:1.0");
		let descriptor2 = Descriptor.fromString("pip-dummies:controller:default:default:1.0");
