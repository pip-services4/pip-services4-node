...
const AnyValueMap_1 = require("../../src/data/AnyValueMap");
...
suite('ConfigParams', () => {
    ...
    test('Config From Object', () => {
        let value = AnyValueMap_1.AnyValueMap.fromTuples("field1", ConfigParams_1.ConfigParams.fromString("field11=123;field12=ABC"), "field2", AnyValueArray_1.AnyValueArray.fromValues(123, "ABC", ConfigParams_1.ConfigParams.fromString("field21=543;field22=XYZ")), "field3", true);
