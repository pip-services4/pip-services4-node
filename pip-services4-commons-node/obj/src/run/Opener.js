...
class Opener {
     ...
     * @see [[IOpenable]]
     */
    static openOne(correlationId, component) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof component.open === "function") {
                yield component.open(correlationId);
            }
        });
    }
    /**
     ...
     * @see [[IOpenable]]
     */
    static open(correlationId, components) {
        return __awaiter(this, void 0, void 0, function* () {
            for (let component of components) {
                yield Opener.openOne(correlationId, component);
            }
        });
    }
}
