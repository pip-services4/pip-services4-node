...
class DummyPersistenceFixture {
    ...
    testCrudOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dummy = yield this._persistence.updatePartially(null, dummy1.id, pip_services3_commons_node_1.AnyValueMap.fromTuples('content', 'Partially Updated Content 1'));
            assert.isNotNull(dummy);
            assert.equal(dummy1.id, dummy.id);
            assert.equal(dummy1.key, dummy.key);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (let d = 0; d < 20; d++) {
                yield this._persistence.create(null, {
                    "id": pip_services3_commons_node_2.RandomString.nextString(16, 16),
                    "content": pip_services3_commons_node_2.RandomString.nextString(1, 50),
                    "key": `Key ${d}`
                });
            }
