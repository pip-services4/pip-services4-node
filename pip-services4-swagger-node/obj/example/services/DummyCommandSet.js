...
class DummyCommandSet extends pip_services4_rpc_node_1.CommandSet {
    ...
    makeGetPageByFilterCommand() {
        return new pip_services4_rpc_node_1.Command("get_dummies", new pip_services4_data_node_1.ObjectSchema(true)
            ...
            .withOptionalProperty("paging", new pip_services4_data_node_1.PagingParamsSchema()), (context, args) => __awaiter(this, void 0, void 0, function* () {
            const filter = pip_services4_data_node_1.FilterParams.fromValue(args.get("filter"));
            const paging = pip_services4_data_node_1.PagingParams.fromValue(args.get("paging"));
