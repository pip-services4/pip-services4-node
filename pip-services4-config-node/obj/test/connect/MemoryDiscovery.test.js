...
suite('MemoryDiscovery', () => {
    let config = pip_services4_components_node_1.ConfigParams.fromTuples("key1.host", "10.1.1.100", "key1.port", "8080", "key2.host", "10.1.1.101", "key2.port", "8082");
    test('Resolve connections', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Resolve one
        let connection = yield discovery.resolveOne(pip_services4_components_node_1.Context.fromTraceId("context"), "key1");
        assert.equal("10.1.1.100", connection.getHost());
        assert.equal(8080, connection.getPort());
        connection = yield discovery.resolveOne(pip_services4_components_node_1.Context.fromTraceId("context"), "key2");
