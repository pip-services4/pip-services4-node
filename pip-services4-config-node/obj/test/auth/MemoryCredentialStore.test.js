...
const MemoryCredentialStore_1 = require("../../src/auth/MemoryCredentialStore");
suite('MemoryCredentialStore', () => {
    test('Lookup and store test', () => __awaiter(void 0, void 0, void 0, function* () {
        let config = pip_services4_components_node_1.ConfigParams.fromTuples('key1.user', 'user1', 'key1.pass', 'pass1', 'key2.user', 'user2', 'key2.pass', 'pass2');
        let credentialStore = new MemoryCredentialStore_1.MemoryCredentialStore();
        credentialStore.readCredentials(config);
        let cred1 = yield credentialStore.lookup(pip_services4_components_node_1.Context.fromTraceId("context"), 'key1');
        let cred2 = yield credentialStore.lookup(pip_services4_components_node_1.Context.fromTraceId("context"), 'key2');
