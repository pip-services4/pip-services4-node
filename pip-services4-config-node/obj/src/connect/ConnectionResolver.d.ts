...
export declare class ConnectionResolver {
     ...
     * @see [[IDiscovery]]
     */
    resolve(context: IContext): Promise<ConnectionParams>;
     ...
     * @see [[IDiscovery]]
     */
    resolveAll(context: IContext): Promise<ConnectionParams[]>;
     ...
     * @see [[IDiscovery]]
     */
    register(context: IContext, connection: ConnectionParams): Promise<void>;
}
