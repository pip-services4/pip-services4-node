...
class DummyClientFixture {
    ...
    testCrudOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dummy2 = dummy;
            // Get all dummies
            let dummies = yield this._client.getDummies(null, new pip_services4_data_node_1.FilterParams(), new pip_services4_data_node_2.PagingParams(0, 5, false));
            ...
            let result = yield this._client.checkTraceId(pip_services4_components_node_1.Context.fromTraceId("test_cor_id"));
