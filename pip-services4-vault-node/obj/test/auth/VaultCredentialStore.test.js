...
suite('VaultCredentialStore', () => {
    ...
    let credentials = pip_services3_commons_node_1.ConfigParams.fromTuples('credKey1.user', 'user1', 'credKey1.pass', 'pass1', 'credKey2.user', 'user2', 'credKey2.pass', 'pass2');
    ...
    test('Lookup and store test', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let credConfig = pip_services3_components_node_1.CredentialParams.fromTuples('user', 'user3', 'pass', 'pass3', 'access_id', '123');
        ...
        credConfig = pip_services3_components_node_1.CredentialParams.fromTuples('user', 'new_user', 'pass', 'new_pass', 'access_id', 'new_id');
