...
suite('AzureConnectionParams', () => {
    ...
    test('Compose Config', () => __awaiter(void 0, void 0, void 0, function* () {
        const config1 = pip_services3_commons_node_1.ConfigParams.fromTuples('connection.uri', 'http://myapp.azurewebsites.net/api/myfunction', 'credential.auth_code', '1234');
        const config2 = pip_services3_commons_node_1.ConfigParams.fromTuples('connection.protocol', 'http', 'connection.app_name', 'myapp', 'connection.function_name', 'myfunction', 'credential.auth_code', '1234');
