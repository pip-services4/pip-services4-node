...
exports.AzureFunctionController = void 0;
...
class AzureFunctionController {
    ...
    applyValidation(schema, action) {
        ...
        const actionWrapper = (reqContext) => __awaiter(this, void 0, void 0, function* () {
            // Validate object
            ...
            const result = yield action.call(this, reqContext);
            return result;
        });
    ...
    registerInterceptor(cmd, action) {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const self = this;
        const interceptorWrapper = (req, next) => __awaiter(this, void 0, void 0, function* () {
...
exports.AzureFunctionController = AzureFunctionController;
//# sourceMappingURL=AzureFunctionController.js.map