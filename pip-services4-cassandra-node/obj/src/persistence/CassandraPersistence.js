...
class CassandraPersistence {
    ...
    constructor(tableName, keyspaceName) {
         ...
         */
        this._dependencyResolver = new pip_services3_commons_node_6.DependencyResolver(CassandraPersistence._defaultConfig);
        /**
         * The logger.
         */
...
CassandraPersistence._defaultConfig = pip_services3_commons_node_1.ConfigParams.fromTuples("collection", null, "dependencies.connection", "*:connection:cassandra:*:1.0", 
// connections.*
// credential.*
