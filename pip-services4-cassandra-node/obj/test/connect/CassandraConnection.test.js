...
suite('CassandraConnection', () => {
    ...
    setup(() => __awaiter(void 0, void 0, void 0, function* () {
        let dbConfig = pip_services3_commons_node_1.ConfigParams.fromTuples('connection.uri', cassandraUri, 'connection.host', cassandraHost, 'connection.port', cassandraPort, 'connection.keyspace', cassandraKeyspace, 'connection.datacenter', cassandraDatacenter, 'credential.username', cassandraUser, 'credential.password', cassandraPassword);
