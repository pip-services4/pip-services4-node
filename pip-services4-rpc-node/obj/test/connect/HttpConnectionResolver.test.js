...
suite('HttpConnectionResolver', () => {
    test('Resolve URI', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.uri", "http://somewhere.com:777"));
    ...
    test('Resolve Parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        let resolver = new HttpConnectionResolver_1.HttpConnectionResolver();
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.protocol", "http", "connection.host", "somewhere.com", "connection.port", 777));
        let connection = yield resolver.resolve(null);
    ...
    test('TestHttpsWithCredentialsConnectionParams', () => __awaiter(void 0, void 0, void 0, function* () {
        let resolver = new HttpConnectionResolver_1.HttpConnectionResolver();
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.host", "somewhere.com", "connection.port", 123, "connection.protocol", "https", "credential.ssl_key_file", "ssl_key_file", "credential.ssl_crt_file", "ssl_crt_file"));
        let connection = yield resolver.resolve(null);
    ...
    test('TestHttpsWithNoCredentialsConnectionParams', () => __awaiter(void 0, void 0, void 0, function* () {
        let resolver = new HttpConnectionResolver_1.HttpConnectionResolver();
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.host", "somewhere.com", "connection.port", 123, "connection.protocol", "https", "credential.internal_network", "internal_network"));
        let connection = yield resolver.resolve(null);
        assert.equal("https", connection.getAsString("protocol"));
        assert.equal("somewhere.com", connection.getAsString("host"));
        assert.equal(123, connection.getAsInteger("port"));
    ...
    test('TestHttpsWithMissingCredentialsConnectionParams', () => __awaiter(void 0, void 0, void 0, function* () {
        // section missing
        let resolver = new HttpConnectionResolver_1.HttpConnectionResolver();
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.host", "somewhere.com", "connection.port", 123, "connection.protocol", "https"));
        try {
        ...
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.host", "somewhere.com", "connection.port", 123, "connection.protocol", "https", "credential.ssl_key_file", "ssl_key_file"));
        try {
            yield resolver.resolve(null);
            assert.fail("Should throw an exception");
        }
        ...
        resolver = new HttpConnectionResolver_1.HttpConnectionResolver();
        resolver.configure(pip_services3_commons_node_1.ConfigParams.fromTuples("connection.host", "somewhere.com", "connection.port", 123, "connection.protocol", "https", "credential.ssl_crt_file", "ssl_crt_file"));
        try {
            yield resolver.resolve(null);
            assert.fail("Should throw an exception");
        }
