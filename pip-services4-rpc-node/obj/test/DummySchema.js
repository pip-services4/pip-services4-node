...
class DummySchema extends pip_services3_commons_node_3.ObjectSchema {
    constructor() {
        super();
        ...
        this.withOptionalProperty("array", new pip_services3_commons_node_2.ArraySchema(new SubDummySchema_1.SubDummySchema()));
    }
}
