...
suite('DummyDirectClient', () => {
    ...
    suiteSetup(() => __awaiter(void 0, void 0, void 0, function* () {
        let ctrl = new DummyService_1.DummyService();
        client = new DummyDirectClient_1.DummyDirectClient();
        let references = pip_services4_components_node_2.References.fromTuples(new pip_services4_components_node_1.Descriptor('pip-services-dummies', 'service', 'default', 'default', '1.0'), ctrl);
