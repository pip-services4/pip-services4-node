...
suite('DummyCommandableHttpService', () => {
    ...
    let service;
    let rest;
    let restConfig = pip_services3_commons_node_2.ConfigParams.fromTuples("connection.protocol", "http", "connection.host", "localhost", "connection.port", 3000, "swagger.enable", "true");
    suiteSetup(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let references = pip_services3_commons_node_3.References.fromTuples(new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'controller', 'default', 'default', '1.0'), ctrl, new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'service', 'http', 'default', '1.0'), service);
    ...
    test('OpenApi Spec Override', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield service.close(null);
        let config = restConfig.setDefaults(pip_services3_commons_node_2.ConfigParams.fromTuples("swagger.auto", false));
        let ctrl = new DummyController_1.DummyController();
        service = new DummyCommandableHttpService_1.DummyCommandableHttpService();
