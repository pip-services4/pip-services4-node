...
class DummyRestService extends RestService_1.RestService {
    ...
    getPageByFilter(req, res) {
        let promise = this._controller.getPageByFilter(this.getCorrelationId(req), new pip_services3_commons_node_2.FilterParams(req.params), new pip_services3_commons_node_3.PagingParams(req.params));
    ...
    register() {
        ...
        this.registerRoute('get', '/dummies', new pip_services3_commons_node_4.ObjectSchema(true)
            ...
            .withOptionalProperty("total", pip_services3_commons_node_5.TypeCode.String)
            .withOptionalProperty("body", new pip_services3_commons_node_6.FilterParamsSchema()), this.getPageByFilter);
        this.registerRoute("get", "/dummies/check/correlation_id", new pip_services3_commons_node_4.ObjectSchema(true), this.checkCorrelationId);
        ...
        this.registerRoute('put', '/dummies', new pip_services3_commons_node_4.ObjectSchema(true)
