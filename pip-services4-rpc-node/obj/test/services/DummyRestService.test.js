...
let restConfig = pip_services3_commons_node_3.ConfigParams.fromTuples("connection.protocol", "http", "connection.host", "localhost", "connection.port", 3000, "swagger.enable", "true", "swagger.content", "swagger yaml or json content" // for test only
);
suite('DummyRestService', () => {
    ...
    suiteSetup(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let references = pip_services3_commons_node_4.References.fromTuples(new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'controller', 'default', 'default', '1.0'), ctrl, new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'service', 'rest', 'default', '1.0'), service);
    ...
    test('Get OpenApi Spec From File', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let filename = 'dummy_' + pip_services3_commons_node_2.IdGenerator.nextLong() + '.tmp';
        let client = restify.createStringClient({ url: 'http://localhost:3000', version: '*' });
        // create temp file
        yield new Promise((resolve, reject) => {
        ...
        yield service.close(null);
        let serviceConfig = pip_services3_commons_node_3.ConfigParams.fromTuples("connection.protocol", "http", "connection.host", "localhost", "connection.port", 3000, "swagger.enable", "true", "swagger.path", filename // for test only
        );
        let ctrl = new DummyController_1.DummyController();
        service = new DummyRestService_1.DummyRestService();
