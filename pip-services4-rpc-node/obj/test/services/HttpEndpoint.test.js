...
suite('HttpEndpoint', () => {
    ...
    suiteSetup(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        service.configure(pip_services3_commons_node_2.ConfigParams.fromTuples('base_route', '/api/v1'));
        endpoint = new HttpEndpoint_1.HttpEndpoint();
        endpoint.configure(restConfig);
        let references = pip_services3_commons_node_3.References.fromTuples(new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'controller', 'default', 'default', '1.0'), ctrl, new pip_services3_commons_node_1.Descriptor('pip-services-dummies', 'service', 'rest', 'default', '1.0'), service, new pip_services3_commons_node_1.Descriptor('pip-services', 'endpoint', 'http', 'default', '1.0'), endpoint);
