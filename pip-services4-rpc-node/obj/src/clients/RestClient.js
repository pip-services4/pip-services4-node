    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._client = null;
                throw new pip_services3_commons_node_3.ConnectionException(correlationId, "CANNOT_CONNECT", "Connection to REST service failed").wrap(err).withDetails("url", this._uri);
            }
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                if (method == 'get')
                    ...
                    let err = new pip_services3_commons_node_4.UnknownException(correlationId, 'UNSUPPORTED_METHOD', 'Method is not supported by REST client').withDetails('verb', method);
                    reject(err);
                }
            });
        });
