...
class CommandableSwaggerDocument {
    constructor(baseRoute, config, commands) {
        ...
        config = config !== null && config !== void 0 ? config : new pip_services3_commons_node_2.ConfigParams();
    ...
    createPropertyTypeData(propertyType) {
        if (propertyType instanceof pip_services3_commons_node_3.ObjectSchema) {
            ...
            var typeCode;
            if (propertyType in pip_services3_commons_node_5.TypeCode) {
                typeCode = propertyType;
            }
            else {
                typeCode = pip_services3_commons_node_4.TypeConverter.toTypeCode(propertyType);
            }
            if (typeCode == pip_services3_commons_node_5.TypeCode.Unknown || typeCode == pip_services3_commons_node_5.TypeCode.Map) {
                typeCode = pip_services3_commons_node_5.TypeCode.Object;
            }
            switch (typeCode) {
                case pip_services3_commons_node_5.TypeCode.Integer:
                    return new Map([
                        ["type", "integer"],
                        ["format", "int32"]
                    ]);
                case pip_services3_commons_node_5.TypeCode.Long:
                    return new Map([
                        ["type", "number"],
                        ["format", "int64"]
                    ]);
                case pip_services3_commons_node_5.TypeCode.Float:
                    return new Map([
                        ["type", "number"],
                        ["format", "float"]
                    ]);
                case pip_services3_commons_node_5.TypeCode.Double:
                    return new Map([
                        ["type", "number"],
                        ["format", "double"]
                    ]);
                case pip_services3_commons_node_5.TypeCode.DateTime:
                    return new Map([
                        ["type", "string"],
                        ["format", "date-time"]
                    ]);
                default:
                    return new Map([
                        ["type", pip_services3_commons_node_4.TypeConverter.toString(typeCode)]
                    ]);
            }
        }
    }
