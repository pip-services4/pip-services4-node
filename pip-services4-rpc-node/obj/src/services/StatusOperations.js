...
class StatusOperations extends RestOperations_1.RestOperations {
    constructor() {
        ...
        this._dependencyResolver.put("context-info", new pip_services3_commons_node_1.Descriptor("pip-services", "context-info", "default", "*", "1.0"));
    }
    /**
    ...
    status(req, res) {
        ...
        let status = {
            ...
            start_time: pip_services3_commons_node_2.StringConverter.toString(this._startTime),
            current_time: pip_services3_commons_node_2.StringConverter.toString(new Date()),
            uptime: uptime,
