...
class ManagedReferences extends ReferencesDecorator_1.ReferencesDecorator {
    ...
    constructor(tuples = null) {
        super(null, null);
        this._references = new pip_services4_components_node_1.References(tuples);
    ...
    open(context) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._linker.open(context);
            yield this._runner.open(context);
        });
    }
    /**
    ...
    close(context) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._runner.close(context);
            yield this._linker.close(context);
        });
    }
    /**
