...
class RunReferencesDecorator extends ReferencesDecorator_1.ReferencesDecorator {
    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._opened) {
                ...
                yield pip_services3_commons_node_1.Opener.open(correlationId, components);
                this._opened = true;
            }
        });
    }
    ...
    close(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._opened) {
                let components = this.getAll();
                yield pip_services3_commons_node_2.Closer.close(correlationId, components);
                this._opened = false;
            }
        });
    }
    ...
    put(locator, component) {
        ...
        if (this._opened) {
            pip_services3_commons_node_1.Opener.openOne(null, component);
        }
    }
    /**
    ...
    remove(locator) {
        ...
        if (this._opened) {
            pip_services3_commons_node_2.Closer.closeOne(null, component);
        }
        return component;
    }
    /**
    ...
    removeAll(locator) {
        ...
        if (this._opened) {
            pip_services3_commons_node_2.Closer.close(null, components);
        }
        return components;
    }
}
