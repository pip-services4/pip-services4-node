 ...
 * @see [[CompositeLogger]]
 */
class DefaultLoggerFactory extends pip_services4_components_node_2.Factory {
    /**
...
DefaultLoggerFactory.NullLoggerDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "logger", "null", "*", "1.0");
DefaultLoggerFactory.ConsoleLoggerDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "logger", "console", "*", "1.0");
DefaultLoggerFactory.CompositeLoggerDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "logger", "composite", "*", "1.0");
