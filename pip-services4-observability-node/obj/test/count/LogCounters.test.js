...
suite('LogCounters', () => {
    ...
    setup(() => {
        ...
        let refs = pip_services4_components_node_1.References.fromTuples(new pip_services4_components_node_2.Descriptor("pip-services", "logger", "null", "default", "1.0"), log);
