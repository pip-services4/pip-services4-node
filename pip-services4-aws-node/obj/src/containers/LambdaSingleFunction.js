...
exports.LambdaSingleFunction = void 0;
/** @module containers */
/** @hidden */
 ...
 */
class LambdaSingleFunction extends pip_services4_container_node_1.Container {
    /**
     ...
     */
    registerSingleAction(schema, action) {
        if (action == null) {
    ...
    execute(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (action == null) {
                throw new pip_services4_commons_node_1.BadRequestException(context, "NO_ACTION", "Action was not found in " + this._name).withDetails("single_function_name", this._name);
            }
            return action(event);
        });
    }
...
exports.LambdaSingleFunction = LambdaSingleFunction;
//# sourceMappingURL=LambdaSingleFunction.js.map