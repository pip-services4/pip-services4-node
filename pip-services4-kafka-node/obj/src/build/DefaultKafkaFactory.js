 ...
 */
class DefaultKafkaFactory extends pip_services4_components_node_1.Factory {
    /**
...
DefaultKafkaFactory.KafkaQueueDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "message-queue", "kafka", "*", "1.0");
DefaultKafkaFactory.KafkaConnectionDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "connection", "kafka", "*", "1.0");
DefaultKafkaFactory.KafkaQueueFactoryDescriptor = new pip_services4_components_node_1.Descriptor("pip-services", "queue-factory", "kafka", "*", "1.0");
