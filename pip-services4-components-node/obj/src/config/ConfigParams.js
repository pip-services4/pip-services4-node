 ...
 *
 */
class ConfigParams extends pip_services4_commons_node_1.StringValueMap {
    /**
    ...
    getSection(section) {
        ...
        for (const key in this) {
            if (Object.prototype.hasOwnProperty.call(this, key)) {
                ...
                const keyPrefix = key.substring(0, prefix.length);
                if (keyPrefix == prefix) {
    ...
    addSection(section, sectionParams) {
        ...
        if (sectionParams != null) {
            for (const key in sectionParams) {
                if (Object.prototype.hasOwnProperty.call(sectionParams, key)) {
                    let name = key;
    ...
    override(configParams) {
        const map = pip_services4_commons_node_1.StringValueMap.fromMaps(this, configParams);
    ...
    setDefaults(defaultConfigParams) {
        const map = pip_services4_commons_node_1.StringValueMap.fromMaps(defaultConfigParams, this);
        return new ConfigParams(map);
    }
    /**
    ...
    static fromValue(value) {
        const map = pip_services4_commons_node_2.RecursiveObjectReader.getProperties(value);
        return new ConfigParams(map);
    }
    /**
    ...
    static mergeConfigs(...configs) {
        const map = pip_services4_commons_node_1.StringValueMap.fromMaps(...configs);
        return new ConfigParams(map);
    }
}
