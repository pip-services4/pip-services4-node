...
class ConfigParams extends pip_services4_commons_node_1.StringValueMap {
    ...
    override(configParams) {
        let map = pip_services4_commons_node_1.StringValueMap.fromMaps(this, configParams);
    ...
    setDefaults(defaultConfigParams) {
        let map = pip_services4_commons_node_1.StringValueMap.fromMaps(defaultConfigParams, this);
        return new ConfigParams(map);
    }
    /**
    ...
    static fromValue(value) {
        let map = pip_services4_commons_node_2.RecursiveObjectReader.getProperties(value);
        return new ConfigParams(map);
    }
    /**
    ...
    static mergeConfigs(...configs) {
        let map = pip_services4_commons_node_1.StringValueMap.fromMaps(...configs);
        return new ConfigParams(map);
    }
}
