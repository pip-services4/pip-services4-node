...
class LogCounters extends CachedCounters_1.CachedCounters {
    ...
    counterToString(counter) {
        ...
        if (counter.last != null)
            result += ", \"last\": " + pip_services3_commons_node_1.StringConverter.toString(counter.last);
        if (counter.count != null)
            result += ", \"count\": " + pip_services3_commons_node_1.StringConverter.toString(counter.count);
        if (counter.min != null)
            result += ", \"min\": " + pip_services3_commons_node_1.StringConverter.toString(counter.min);
        if (counter.max != null)
            result += ", \"max\": " + pip_services3_commons_node_1.StringConverter.toString(counter.max);
        if (counter.average != null)
            result += ", \"avg\": " + pip_services3_commons_node_1.StringConverter.toString(counter.average);
        if (counter.time != null)
            result += ", \"time\": " + pip_services3_commons_node_1.StringConverter.toString(counter.time);
        result += " }";
        return result;
    }
    /**
