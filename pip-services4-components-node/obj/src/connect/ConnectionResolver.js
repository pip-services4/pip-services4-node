...
class ConnectionResolver {
    ...
    resolveInDiscovery(correlationId, connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (discoveries.length == 0) {
                throw new pip_services3_commons_node_2.ReferenceException(correlationId, discoveryDescriptor);
            }
    ...
    resolve(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let connection of connections) {
                ...
                if (result != null) {
                    resolved = new ConnectionParams_1.ConnectionParams(pip_services3_commons_node_1.ConfigParams.mergeConfigs(connection, result));
                }
            }
            return resolved;
        });
    ...
    registerInDiscovery(correlationId, connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let discoveries = this._references.getOptional(new pip_services3_commons_node_3.Descriptor("*", "discovery", "*", "*", "*"));
            if (discoveries == null) {
                return false;
            }
            for (let discovery of discoveries) {
