...
class CompositeConnectionResolver {
    ...
    resolve(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (connections.length > 0 && !this._clusterSupported) {
                throw new pip_services3_commons_node_2.ConfigException(correlationId, "MULTIPLE_CONNECTIONS_NOT_SUPPORTED", "Multiple (cluster) connections are not supported");
            }
    ...
    validateConnection(correlationId, connection) {
        if (connection == null) {
            throw new pip_services3_commons_node_2.ConfigException(correlationId, "NO_CONNECTION", "Connection parameters are not set is not set");
        }
