...
suite('ContextInfo', () => {
    ...
    test('FromConfig', () => {
        let config = pip_services3_commons_node_1.ConfigParams.fromTuples("name", "new name", "description", "new description", "properties.access_key", "key", "properties.store_key", "store key");
