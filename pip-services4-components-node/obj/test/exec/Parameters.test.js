...
suite('Parameters', () => {
    test('Defaults', () => {
        ...
        let defaults = Parameters_1.Parameters.fromTuples("value2", 432, "value3", 345);
    ...
    test('Override Recursive', () => {
        let result = Parameters_1.Parameters.fromJson("{ \"value1\": 123, \"value2\": { \"value21\": 111, \"value22\": 222 } }");
        let defaults = Parameters_1.Parameters.fromJson("{ \"value2\": { \"value22\": 777, \"value23\": 333 }, \"value3\": 345 }");
    ...
    test('Override With Nulls', () => {
        let result = Parameters_1.Parameters.fromJson("{ \"value1\": 123, \"value2\": 234 }");
    ...
    test('Assign To', () => {
        let value = new TestClass_1.TestClass(null, null);
        let newValues = Parameters_1.Parameters.fromJson("{ \"value1\": 123, \"value2\": \"ABC\", \"value3\": 456 }");
    ...
    test('Get', () => {
        let config = Parameters_1.Parameters.fromJson("{ \"value1\": 123, \"value2\": { \"value21\": 111, \"value22\": 222 } }");
    ...
    test('Set', () => {
        let config = new Parameters_1.Parameters();
        config.put(null, 123);
    ...
    test('From Config', () => {
        let config = ConfigParams_1.ConfigParams.fromTuples("field1.field11", 123, "field2", "ABC", "field1.field12", "XYZ");
        let parameters = Parameters_1.Parameters.fromConfig(config);
