...
suite('CompositeLogger', () => {
    ...
    setup(() => {
        ...
        let refs = pip_services3_commons_node_1.References.fromTuples(new pip_services3_commons_node_2.Descriptor("pip-services", "logger", "null", "default", "1.0"), new NullLogger_1.NullLogger(), new pip_services3_commons_node_2.Descriptor("pip-services", "logger", "console", "default", "1.0"), new ConsoleLogger_1.ConsoleLogger());
