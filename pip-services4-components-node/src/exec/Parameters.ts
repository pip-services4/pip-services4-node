...
export class Parameters extends AnyValueMap {
     ...
     * @see [[setDefaults]]
     */
     public override(parameters: Parameters, recursive = false): Parameters {
     ...
     * @see [[override]]
     */
    public setDefaults(defaultParameters: Parameters, recursive = false): Parameters {
         const result = new Parameters();
         if (recursive) {
    ...
    public static mergeParams(...parameters: Parameters[]): Parameters {
        const map = AnyValueMap.fromMaps(...parameters);
        return new Parameters(map);
    }
