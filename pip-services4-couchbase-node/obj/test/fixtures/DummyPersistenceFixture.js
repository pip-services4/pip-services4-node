...
class DummyPersistenceFixture {
    ...
    testPaging() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert.equal(this._dummy1.key, dummy1.key);
            assert.equal(this._dummy1.content, dummy1.content);
            let page = yield this._persistence.getPageByFilter(null, new pip_services4_data_node_1.FilterParams(), new pip_services4_data_node_1.PagingParams(0, 100, true));
            assert.isNotNull(page);
