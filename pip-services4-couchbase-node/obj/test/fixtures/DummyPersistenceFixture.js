...
class DummyPersistenceFixture {
    ...
    testPaging() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert.equal(this._dummy1.key, dummy1.key);
            assert.equal(this._dummy1.content, dummy1.content);
            let page = yield this._persistence.getPageByFilter(null, new pip_services3_commons_node_2.FilterParams(), new pip_services3_commons_node_3.PagingParams(0, 100, true));
            assert.isNotNull(page);
